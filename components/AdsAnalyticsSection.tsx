...
const AdsAnalyticsSection = ({ clientId, clientName }: AdsAnalyticsSectionProps) => {
  ...
  const googleAdsDashboardLinks: Record<string, { label: string; url: string }[]> = {
    ...
    "Snarky Humans": [
      ...
      { label: "Snarky Humans Ads (Legacy)", url: "https://ads.google.com/aw/campaigns?ocid=8013147548&euid=1602160212&__u=6242679988&uscid=8013147548&__c=3140408252&authuser=0&workspaceId=0" },
    ],
  };
