...
const WebAnalyticsClient = ({ clientId }: { clientId: string }) => {
  ...
  return (
    <AnalyticsPageLayout
      ...
      pageName="Web Analytics"
      pageDescription="Website traffic and performance analytics"
                          ...
                          return (
                            <div className="flex flex-col items-center gap-4">
                              ...
                              {errorType === 'not_configured' && (
                                <Button variant="outline" onClick={() => router.push('/admin')} className="mt-2">
...
export default WebAnalyticsClient;
